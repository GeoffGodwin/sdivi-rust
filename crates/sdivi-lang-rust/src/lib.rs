//! Rust language adapter for sdivi-rust.
//!
//! Implements [`sdivi_parsing::adapter::LanguageAdapter`] for `.rs` source files
...
impl LanguageAdapter for RustAdapter {
    ...
    fn parse_file(&self, path: &Path, content: String) -> FeatureRecord {
        ...
        sdivi_parsing::ACTIVE_TREES.fetch_add(1, std::sync::atomic::Ordering::Relaxed);
        ...
        #[cfg(feature = "test-tree-counter")]
        sdivi_parsing::ACTIVE_TREES.fetch_sub(1, std::sync::atomic::Ordering::Relaxed);
