...
fn leaf_matches_fingerprint_node_kind_m07_equivalence() {
    for kind in &["try_expression", "function_definition", "class_definition", "import_statement"] {
...
fn child_order_matters() {
    let c1 = NormalizeNode { kind: "a".to_string(), children: vec![] };
    let c2 = NormalizeNode { kind: "b".to_string(), children: vec![] };
...
fn deterministic_across_calls() {
    let child = NormalizeNode { kind: "body".to_string(), children: vec![] };
