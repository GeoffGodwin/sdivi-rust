...
use sdi_detection::{run_leiden, run_leiden_with_weights, LeidenConfig};
...
fn two_triangles_dg() -> sdi_graph::dependency_graph::DependencyGraph {
...
fn weighted_produces_different_or_better_partition() {
    ...
    assert!(
        ...
        weighted.modularity, unweighted.modularity
    );
}
