# @geoffgodwin/sdi-wasm

WASM bindings for the [Structural Divergence Indexer](https://github.com/geoffgodwin/sdi-rust) pure-compute API.

All `compute_*` functions from `sdi-core` are exported with `tsify`-derived TypeScript types.
