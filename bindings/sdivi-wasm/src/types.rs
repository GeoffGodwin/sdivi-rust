...
fn default_wasm_min_cr() -> f64 {
    0.1
}
fn default_wasm_max_rd() -> u32 {
    32
}
...
pub struct WasmLeidenConfigInput {
    ...
    /// Stop recursive Leiden when compression falls below this ratio. Default `0.1`.
    #[serde(default = "default_wasm_min_cr")]
    #[tsify(optional)]
    pub min_compression_ratio: f64,
    /// Hard cap on Leiden recursion depth. Default `32`.
    #[serde(default = "default_wasm_max_rd")]
    #[tsify(optional)]
