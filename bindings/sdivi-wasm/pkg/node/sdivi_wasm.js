 ...
 * @returns {any}
 */
function assemble_snapshot(input) {
    try {
...
exports.assemble_snapshot = assemble_snapshot;
 ...
 */
function compute_boundary_violations(graph, spec) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_boundary_violations = compute_boundary_violations;
 ...
 */
function compute_change_coupling(events, cfg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_change_coupling = compute_change_coupling;
 ...
 */
function compute_coupling_topology(graph) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_coupling_topology = compute_coupling_topology;
 ...
 */
function compute_delta(prev, curr) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_delta = compute_delta;
 ...
 */
function compute_pattern_metrics(patterns) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_pattern_metrics = compute_pattern_metrics;
 ...
 */
function compute_thresholds_check(summary, cfg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_thresholds_check = compute_thresholds_check;
 ...
 */
function compute_trend(snapshots, last_n) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.compute_trend = compute_trend;
 ...
 */
function detect_boundaries(graph, cfg, prior) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.detect_boundaries = detect_boundaries;
 ...
 */
function infer_boundaries(prior_partitions, stability_threshold) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.infer_boundaries = infer_boundaries;
 ...
 * @returns {string}
 */
function normalize_and_hash(node_kind, children) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.normalize_and_hash = normalize_and_hash;
...
const wasmPath = `${__dirname}/sdivi_wasm_bg.wasm`;
